...
export class GraficosPage implements OnInit, OnDestroy {
  ...
  public barChartData: ChartDataset[] = [{ data: [3, 2, 1], label: 'Cargando...', backgroundColor: ['green', 'blue', 'yellow']  }];
  ...
  public pieChartData: ChartDataset[] =  [{ data: [4, 2, 1], label:  'Cargando...', backgroundColor: ['green', 'blue', 'yellow'] }, ];
